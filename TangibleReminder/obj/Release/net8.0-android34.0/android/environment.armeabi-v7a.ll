...
@dso_cache = dso_local local_unnamed_addr global [576 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 511993942, ; hash 0x1e846856, from name: libaot-TangibleReminder
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 556487949, ; hash 0x212b550d, from name: TangibleReminder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TangibleReminder.dll.so
		ptr null; void* handle (0x0)
	}, ; 70
	...
	%struct.DSOCacheEntry {
		i64 728783482, ; hash 0x2b705a7a, from name: aot-TangibleReminder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TangibleReminder.dll.so
		ptr null; void* handle (0x0)
	}, ; 87
	...
	%struct.DSOCacheEntry {
		i64 853794468, ; hash 0x32e3dea4, from name: libaot-TangibleReminder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TangibleReminder.dll.so
		ptr null; void* handle (0x0)
	}, ; 107
	...
	%struct.DSOCacheEntry {
		i64 1422931675, ; hash 0x54d036db, from name: TangibleReminder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TangibleReminder.dll.so
		ptr null; void* handle (0x0)
	}, ; 188
	...
	%struct.DSOCacheEntry {
		i64 1652689004, ; hash 0x6282086c, from name: aot-TangibleReminder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TangibleReminder.dll.so
		ptr null; void* handle (0x0)
	}, ; 213
