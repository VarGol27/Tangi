...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100671072, ; uint32_t jnienv_initialize_method_token (0x6001e60)
	i32 100671071, ; uint32_t jnienv_registerjninatives_method_token (0x6001e5f)
...
@dso_cache = dso_local local_unnamed_addr global [576 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1090441272644081797, ; hash 0xf22068f60601885, from name: aot-TangibleReminder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TangibleReminder.dll.so
		ptr null; void* handle (0x0)
	}, ; 27
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2095982633077262931, ; hash 0x1d166d198bf54a53, from name: TangibleReminder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TangibleReminder.dll.so
		ptr null; void* handle (0x0)
	}, ; 55
	...
	%struct.DSOCacheEntry {
		i64 3651880044109114747, ; hash 0x32ae158d37762d7b, from name: libaot-TangibleReminder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TangibleReminder.dll.so
		ptr null; void* handle (0x0)
	}, ; 110
	...
	%struct.DSOCacheEntry {
		i64 4383628824503088531, ; hash 0x3cd5c730bfab7593, from name: aot-TangibleReminder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TangibleReminder.dll.so
		ptr null; void* handle (0x0)
	}, ; 129
	...
	%struct.DSOCacheEntry {
		i64 6768697458453097977, ; hash 0x5def3e79f32fadf9, from name: TangibleReminder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TangibleReminder.dll.so
		ptr null; void* handle (0x0)
	}, ; 182
	...
	%struct.DSOCacheEntry {
		i64 12525396211042127936, ; hash 0xadd3257dd6309040, from name: libaot-TangibleReminder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TangibleReminder.dll.so
		ptr null; void* handle (0x0)
	}, ; 390
...
@.env.3 = private unnamed_addr constant [37 x i8] c"d23def2d-4cfa-4c02-a262-83908b0fccee\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [33 x i8] c"com.companyname.tangiblereminder\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [31 x i8] c"libaot-TangibleReminder.dll.so\00", align 16
